...
- Secondary text must stay easy to read (owner, v645/v646): text in Stage is pure white (`ink`, `ink-muted` #FFFFFF, `ink-faint` #F2F2F2, chart line `viz-1` #FFFFFF — never warm/beige) and pure black #000000 in Paper (`ink`, `ink-muted`, `ink-faint`, `viz-1`). Don't reintroduce soft greys for labels, sub-lines or chart text.
