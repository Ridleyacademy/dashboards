...
- Secondary text must stay easy to read (owner, v645/v646): text in Stage is pure white (`ink`, `ink-muted` #FFFFFF, `ink-faint` #F2F2F2, chart line `viz-1` #FFFFFF — never warm/beige) and near-black in Paper. Don't reintroduce soft greys for labels, sub-lines or chart text.
