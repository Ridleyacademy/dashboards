...
- Secondary text must stay easy to read (owner, v645/v646): `ink-muted`/`ink-faint` are near-white in Stage and near-black in Paper. Don't reintroduce soft greys for labels, sub-lines or chart text.
