...
**Still pending:** independent keep-alive so each room never expires (replaces the roll); rebuild Rex (81434169178) + Madison (83187986921) dead rooms; re-enable the scheduler cron on go-ahead.
**Touched:** zoom-meetings v50 (deployed+synced+syntax-verified, 66350 bytes), zoom-join v4 (sha d2dd29b3…), j/index.html (branded reg + directory, pushed), crons 6/9 paused. v50 build ACTIVE (compiles).
