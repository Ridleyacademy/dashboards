...
(function () {
  ...
  const ENTRIES = [
  { version: 652, date: '2026-09-24', title: 'Text is bolder and easier to read', items: ['Small text was drawn so thin that black looked grey in light mode and white looked grey in dark mode. Text is now a bit bolder everywhere, and the chart dates, scale numbers and values are bolder and slightly bigger, so black reads as black and white as white. On Weekly Stats and Webinars.'] },
  { version: 651, date: '2026-09-24', title: 'Dark mode: chart dates and scales are white too', items: ['The dates under the charts, the numbers up the side and the small grey lines (like \u201cvs $5,643\u201d and \u201c13 weeks \u00b7 Automatic\u201d) were a very light grey that looked cream. They are now pure white, like the rest of the text.'] },
  ...
  { version: 642, date: '2026-09-24', title: 'Weekly Stats: two charts per row, and the new look for everyone', items: ['Charts are now two per row (one on phones), so each one is bigger and easier to read.', 'Some browsers kept the old page script after the update, so the headline numbers looked unstyled and the charts still said \u201cderived\u201d. The page now always loads the latest version.'] },
  { version: 641, date: '2026-09-24', title: 'Weekly Stats: the same page in the new Ridley look', items: ['Everything works as before: the tabs, Weekly / Monthly, Current week, the Assigned to filter, the 4 headline numbers and one chart per stat. Click a chart for its history and to change values.', 'The charts are bigger and calmer. The line turns red where a number went the wrong way, and a dashed line still means the stat is typed in by hand.', 'Next to each number: an arrow for which way it moved since the week before, green if that is good and orange if it is bad. For \u201clower is better\u201d stats a drop is green, and those charts are no longer drawn upside down.', 'Quick add, Import CSV, Add manual graph and Reorder are now together under \u201c\u270e Edit\u201d. A \u201cWhat the numbers mean\u201d section sits at the bottom.', 'Light and dark themes both work, and on a tablet the Sign Out button no longer runs off the edge.'] },
  { version: 640, date: '2026-09-24', title: 'Webinars: set when the offer started, per webinar', items: ['\u201cSaw the offer\u201d used to mean stayed 90 minutes, for every webinar. Now each webinar can have its own offer minute: click \u201c\u270e Change\u201d on the Saw the offer step, type the minute, Save.', 'Everything that depends on it updates: saw the offer, stayed-for-the-offer %, cost per offer view, sales per offer viewer, the lead shares and the follow-up call numbers, the ads tables, the live-room offer line and the sheet (new \u201cOffer starts (minute)\u201d column).', 'Webinars you have not changed stay at minute 90.'] },
  { version: 639, date: '2026-09-24', title: 'Webinars: new webinars show up by themselves again', items: ['The webinar list stopped at the first 1,000 registrations, so newer webinars (like Sep 27) never appeared. It now counts every registration.', 'When a new webinar is scheduled, the page opens on it automatically the first time; after that it remembers your choice.', 'Registration totals above 1,000 are now complete too (Sep 20 had 1,135).'] },
  { version: 638, date: '2026-09-24', title: 'Webinars: \u201ctalked to\u201d now means a call of 3 minutes or more', items: ['The follow-up numbers used to count someone as reached after a 1-minute call. It now takes 3 minutes or more on one call, so voicemails and quick hang-ups no longer count as a conversation. Expect the numbers to drop \u2014 Sep 20 leads go from 34 to 12 talked to.'] },
  { version: 637, date: '2026-09-23', title: 'Webinars sheet: nothing shows through the frozen column any more', items: ['The highlighted webinar row was see-through, so numbers scrolling behind the frozen webinar column showed through it. It is solid now.', 'The Average row moved to the top, pinned under the column names \u2014 at the bottom, Safari\u2019s scrollbar let a row peek out underneath it.', 'When you stop scrolling sideways, the sheet settles on a whole column, in every browser.'] },
  { version: 636, date: '2026-09-23', title: 'Webinars sheet: the webinar column stays put', items: ['The webinar column on the left is frozen with a clear edge; the other columns slide behind it and snap to whole columns, so numbers are never half-cut against it. Works the same on phones, with a narrower webinar column.'] },
  { version: 635, date: '2026-09-23', title: 'Webinars: new \u201cAll webinars sheet\u201d view', items: ['A second view at the top of the Webinars page: every webinar as one row, every number as a column \u2014 traffic, the webinar, sales, money, leads, follow-up and texts, like a spreadsheet.', 'Click a column name to sort by it, click a row to open that webinar, search by month. The best value in each column is in bold and the bottom row shows the average.', '\u201cDownload for Google Sheets\u201d saves it as a CSV you can open in Google Sheets or Excel.', 'Older webinars show \u2014 for page visitors and texts, because those weren\u2019t tracked back then (they used to show 0).'] },
  { version: 634, date: '2026-09-23', title: 'Webinars: saw-offer call stats cover everyone again', items: ['The saw-offer call and follow-up speed rows were measuring only the offer viewers who had NOT been handed to a rep, which is why the speed read 24h typical and 0% called within the hour. They now cover everyone who stayed 90 min or more, and the tooltips say the two groups overlap on purpose.'] },
  { version: 633, date: '2026-09-23', title: 'Webinars: a cleaner, easier page in the new Ridley look', items: ['Same numbers as before, easier to read. The funnel is three numbered rows: 1 Getting people in, 2 The webinar, 3 The money. Each arrow shows how many made it to the next step and how that changed since the last webinar.', 'Registrations now appear once. The personal-link share is no longer a headline number.', 'Simple / Detailed switch: Simple shows each step with its cost; Detailed adds the breakdowns (live vs rep, paid in full vs plan, fees, costs, peak room).', 'Leads, sources, ads and the all-webinars table fold away with a one-line summary, and open with one click. The page remembers what you opened.', 'Plain words (Sales, Revenue after fees, $ back per $1) and a \u201cWhat the numbers mean\u201d section at the bottom. Green always means better, including costs going down.'] },
  { version: 632, date: '2026-09-23', title: 'Webinars: SMS moved inside Profit', items: ['The SMS stage is gone from the funnel. Profit now lists what was taken off \u2014 ads, SMS, total \u2014 as sub-stats, since both are revenue removed.', 'A single chip under the stats shows SMS sent vs failed, and how much of the failed was billed anyway.'] },
  { version: 631, date: '2026-09-23', title: 'Webinars: SMS cost split by what it was for', items: ['The SMS stage now breaks into promo, reminder, during the webinar, and follow-up \u2014 so you can see what the reminder run actually costs. Sep 20: $40 of reminders, $72 sent while the webinar was live.'] },
  { version: 630, date: '2026-09-23', title: 'SMS: new health dashboard, and SMS cost in the webinar funnel', items: ['New SMS Health page \u2014 delivery rate by day,per sending number, and every failure code explained with what to do about it.', 'The webinar funnel has an SMS stage: what was spent texting THAT webinar\u2019s registrants, how many failed, and how much went to the leads handed to reps. Profit now subtracts ads AND SMS.', 'Twilio is mirrored hourly into twilio_messages.'] },
  { version: 629, date: '2026-09-23', title: 'Webinars: speed to lead starts at the hand-over', items: ['The clock now starts when the lead was actually handed to a rep (its tag timestamp), not when the webinar ended \u2014 plenty of leads are tagged while the webinar is still running.', 'Hand-over times are recorded in webinar_lead_tags as they are read, so we also finally have a lead-level history AXL does not otherwise expose.'] },
  { version: 628, date: '2026-09-23', title: 'Webinars: speed to lead', items: ['Two new chips show the median time from the webinar ending to the first call \u2014 for the leads handed to the sales team, and for the offer-viewers who were not \u2014 plus the share reached within the hour and the change vs the last webinar.', 'A call placed while the webinar was still running counts as zero minutes, not negative.'] },
  { version: 627, date: '2026-09-23', title: 'Webinars: per-ad split is live / rep, call chips fixed', items: ['The ads and campaign tables now split sales and revenue into live (nobody closed it) and rep (a closer is credited) \u2014 the old attended / registered split was always zero on the second column.', 'The second call chip is now \"Saw offer called\", and both call chips compare against the last webinar in points.', 'Anyone with no phone number on file is out of the denominator \u2014 they were never callable. The count of those is in the tooltip.'] },
  { version: 626, date: '2026-09-23', title: 'Webinars: how many leads actually got a call', items: ['Lead quality now shows how many of the leads handed to the sales team have a call logged, and how many of those connected for a minute or more.', 'A second chip does the same for the offer-viewers who were never handed to a rep \u2014 with the handed-over leads removed, so nobody is counted twice.'] },
  { version: 625, date: '2026-09-22', title: 'Webinars: net revenue itemises what comes off the top', items: ['Net revenue now lists rep commission (10%), rep manager commission (5%), processor fees and the 20% BNPL cost separately, plus the total \u2014 each with its change vs the last webinar.'] },
  { version: 624, date: '2026-09-22', title: 'Webinars: lead quality reads tags, and rebills are out of webinar sales', items: ['Lead quality now counts the AXL TAG, not the current stage \u2014 a lead a rep has already picked up no longer vanishes from cart abandonment into contact attempted. Each one also shows how many of those leads bought.', 'Recurring charges (same person, same product, same price, 20+ days after an earlier one) are no longer counted as webinar sales. Sep 20 goes from 17 to 16 sales.'] },
  { version: 623, date: '2026-09-22', title: 'Webinars: buyers with a mistyped or second email now match the roster', items: ['A buyer whose Sales Log email does not exactly match the webinar roster is matched on the identifying part of the address instead, so a typo (gmail.vom) or a second address still lands on the right webinar. Sep 20 goes from 14 to 16 attendee sales.', 'Peak live and room held now compare against the last webinar \u2014 the previous webinar\u2019s curve is pulled from AXL too.'] },
  ...
  { version: 615, date: '2026-09-22', title: 'Webinars: sales breakdown + step conversions vs last webinar', items: ['The Sales stage now breaks down into live (nobody closed it), rep (a closer is credited), cash and PP \u2014 each with its own change vs the last webinar.', 'Cash vs PP now comes from the Sales Log status instead of a price threshold.', 'Every step arrow (page visitors to registrations, show-up, saw offer, sales) shows how that conversion rate moved in points vs the last webinar.'] },
  { version: 614, date: '2026-09-22', title: 'Webinars: live vs reg sales per ad and campaign', items: ['Every ad, ad set and campaign now splits its sales and revenue into live (the buyer was in the room) and reg (registered but never showed), under the existing totals.', 'No stat was removed \u2014 spend, clicks, CTR, CPM, regs, cost/reg, attended, saw offer, cost/sale, profit and ROAS all stay.'] },
  { version: 613, date: '2026-09-22', title: 'Webinars: last webinar comparison on every stat', items: ["Ad spend, impressions, page visitors, net revenue and profit after ads now show the last webinar's number and the % change too.", 'The cost lines (cost per registration, attendee, offer view, sale, per 1K impressions, ROAS, ROI) carry their own comparison, coloured so cheaper is green.'] },
